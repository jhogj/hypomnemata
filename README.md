...
Estado atual: o app legado FastAPI/React já passou das Ondas 1, 2 e 3; a trilha principal agora é o rewrite nativo em `native/`. No nativo, as Sprints 0, 1, 2, 3, 4, 5.1 e 5.2 estão concluídas em 2026-04-25; próxima etapa: Sprint 5.3 — OCR nativo de imagens/PDFs.
