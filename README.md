...
Estado atual: o app legado FastAPI/React já passou das Ondas 1, 2 e 3; a trilha principal agora é o rewrite nativo em `native/`. No nativo, as Sprints 0, 1, 2, 3, 4 e 5 estão concluídas em 2026-04-25; próxima etapa: Sprint 6 — IA/local LLM e automações nativas, a definir em recortes.
